...
#if defined(_WIN32)
const char* LogChannel::name() { return EleGray "..."; }
const char* LeftChannel::name() { return EleNavy "<--"; }
const char* RightChannel::name() { return EleGreen "-->"; }
const char* WarnChannel::name() { return EleOnRed EleBlackBold "  X"; }
const char* NoteChannel::name() { return EleBlue "  i"; }
const char* DebugChannel::name() { return EleWhite "  D"; }
const char* TraceChannel::name() { return EleGray "..."; }
#else
const char* LogChannel::name() { return EleGray "···"; }
const char* LeftChannel::name() { return EleNavy "◀▬▬"; }
const char* RightChannel::name() { return EleGreen "▬▬▶"; }
const char* WarnChannel::name() { return EleOnRed EleBlackBold "  ✘"; }
const char* NoteChannel::name() { return EleBlue "  ℹ"; }
const char* DebugChannel::name() { return EleWhite "  ◇"; }
const char* TraceChannel::name() { return EleGray "..."; }
#endif
	...
	m_verbosity(_v)
{
	...
	if ((it != s_logOverride.end() && it->second == true) || (it == s_logOverride.end() && (int)_v <= g_logVerbosity))
	{
		...
		static char const* c_begin = "  " EleViolet;
		static char const* c_sep1 = EleReset EleBlack "|" EleNavy;
		static char const* c_sep2 = EleReset EleBlack "|" EleTeal;
		static char const* c_end = EleReset "  ";
...
{
	m_sstr << EleNavyUnder "tcp://" << _t << EleReset;
}
#endif
