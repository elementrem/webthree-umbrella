...
const unsigned dev::p2p::c_defaultIPPort = 30707;
...
#if defined(_WIN32)
const char* NetWarn::name() { return EleYellow "N" EleRed " X"; }
const char* NetImpolite::name() { return EleYellow "N" EleRed " !"; }
const char* NetNote::name() { return EleYellow "N" EleBlue " i"; }
const char* NetConnect::name() { return EleYellow "N" EleYellow " C"; }
const char* NetMessageSummary::name() { return EleYellow "N" EleWhite " ."; }
const char* NetMessageDetail::name() { return EleYellow "N" EleGray " o"; }
const char* NetTriviaSummary::name() { return EleYellow "N" EleGray " O"; }
const char* NetTriviaDetail::name() { return EleYellow "N" EleCoal " 0"; }
const char* NetAllDetail::name() { return EleYellow "N" EleCoal " A"; }
const char* NetRight::name() { return EleYellow "N" EleGreen "->"; }
const char* NetLeft::name() { return EleYellow "N" EleNavy "<-"; }
const char* NetP2PWarn::name() { return EleYellow "N" EleRed " X"; }
const char* NetP2PNote::name() { return EleYellow "N" EleBlue " i"; }
const char* NetP2PConnect::name() { return EleYellow "N" EleYellow " C"; }
#else
const char* NetWarn::name() { return EleYellow "⧎" EleRed " ✘"; }
const char* NetImpolite::name() { return EleYellow "⧎" EleRed " !"; }
const char* NetNote::name() { return EleYellow "⧎" EleBlue " ℹ"; }
const char* NetConnect::name() { return EleYellow "⧎" EleYellow " ▢"; }
const char* NetMessageSummary::name() { return EleYellow "⧎" EleWhite " ◌"; }
const char* NetMessageDetail::name() { return EleYellow "⧎" EleGray " ○"; }
const char* NetTriviaSummary::name() { return EleYellow "⧎" EleGray " ◎"; }
const char* NetTriviaDetail::name() { return EleYellow "⧎" EleCoal " ◍"; }
const char* NetAllDetail::name() { return EleYellow "⧎" EleCoal " ●"; }
const char* NetRight::name() { return EleYellow "⧎" EleGreen "▬▶"; }
const char* NetLeft::name() { return EleYellow "⧎" EleNavy "◀▬"; }
const char* NetP2PWarn::name() { return EleYellow "⧎" EleRed " ✘"; }
const char* NetP2PNote::name() { return EleYellow "⧎" EleBlue " ℹ"; }
const char* NetP2PConnect::name() { return EleYellow "⧎" EleYellow " ▢"; }
#endif
