	...
	m_backgroundJobId(0)
{
	...
	qmlRegisterType<QFunctionDefinition>("org.elementrem.qml", 1, 0, "QFunctionDefinition");
	qmlRegisterType<QVariableDeclaration>("org.elementrem.qml", 1, 0, "QVariableDeclaration");
}
...
GasMapWrapper* CodeModel::gasEstimation(solidity::CompilerStack const& _cs)
{
	...
	try
	{
		for (string n: _cs.contractNames())
		{
			...
			ele::AssemblyItems const& runtimeAssembly = *_cs.runtimeAssemblyItems(n);
