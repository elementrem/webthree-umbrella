...
public:
	...
	ele::AssemblyItems const& assemblyItems() const { return m_assemblyItems; }
	ele::AssemblyItems const& constructorAssemblyItems() const { return m_constructorAssemblyItems; }
	...
	/// linker object
	ele::LinkerObject& linkerObject() { return m_linkerObject; }
...
private:
	...
	ele::AssemblyItems m_assemblyItems;
	ele::AssemblyItems m_constructorAssemblyItems;
	QHash<LocationPair, SolidityDeclaration> m_locals;
	QHash<unsigned, SolidityDeclarations> m_storage;
	ele::LinkerObject m_linkerObject;
...
private:
	...
	dev::ele::EVMSchedule m_schedule;	///< schedule under which we're working. TODO: make relevant to supposed context.
