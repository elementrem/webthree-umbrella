...
#include <libelementrem/TransactionReceipt.h>
...
struct ExecutionResult
{
	...
	dev::ele::ExecutionResult result;
	dev::Address address;
	dev::Address sender;
	...
	ele::LocalisedLogEntries logs;
	ele::TransactionException excepted = ele::TransactionException::Unknown;
