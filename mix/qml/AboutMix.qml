	...
	contentItem: Rectangle {
		...
		RowLayout
		{
			...
			ColumnLayout
			{
				...
				DefaultLabel
				{
					text: qsTr("<a href='https://github.com/elementrem/mix'><font color=\"cornflowerblue\" size=\"3\">Source code</font></a>")
					onLinkActivated: Qt.openUrlExternally(link)
				}

				DefaultLabel
				{
					text: qsTr("<a href='http://forum.elementrem.org/categories/mix'><font color=\"cornflowerblue\" size=\"3\">Forum</font></a>")
					onLinkActivated: Qt.openUrlExternally(link)
				}
				...
				DefaultLabel
				{
					text: qsTr("<a href='https://elementrem.org/'><font color=\"cornflowerblue\" size=\"3\">Visit us\n</font></a>")
					onLinkActivated: Qt.openUrlExternally(link)
				}
