...
var addrNameReg;
web3.ele.contract(addrConfig, abiConfig).lookup(1).call().then(function(r){ addrNameReg = r; })
...
// Example JS use:
web3.ele.contract(addrNameReg, abiNameReg).register("My Name").transact();
