...
public:
	...
	using IdentifierAccess = std::function<bool(assembly::Identifier const&, ele::Assembly&, IdentifierContext)>;
	...
	ele::Assembly assemble(IdentifierAccess const& _identifierAccess = IdentifierAccess());
	/// Performs code generation and appends generated to to _assembly.
	void assemble(ele::Assembly& _assembly, IdentifierAccess const& _identifierAccess = IdentifierAccess());
