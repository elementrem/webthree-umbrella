...
.. index:: mey, finney, szabo, element

Element Units
===========

A literal number can take a suffix of ``mey``, ``finney``, ``szabo`` or ``element`` to convert between the subdenominations of Element, where Element currency numbers without a postfix are assumed to be "mey", e.g. ``2 element == 2000 finney`` evaluates to ``true``.
