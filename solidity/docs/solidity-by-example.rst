    ...
    contract Ballot {
        ...
        function giveRightToVote(address voter) {
            if (msg.sender != chairperson || voters[voter].voted) {
                ...
                // the state and to Element balances. It is often
...
completely blind auction contract on Elementrem.
...
money / element in order to bind the bidders to their
...
::
    ...
    contract SimpleAuction {
        ...
        function () {
            ...
            // the contract or just element without data.
...
be blinded in Elementrem, anyone can see the value.
...
::
    ...
    contract BlindAuction {
        ...
        /// fake, secret).
        /// The sent element is only refunded if the bid is correctly
        /// revealed in the revealing phase. The bid is valid if the
        /// element sent together with the bid is at least "value" and
...
::
    ...
    contract Purchase {
        ...
        /// Abort the purchase and reclaim the element.
        ...
        /// Transaction has to include `2 * value` element.
        /// The element will be locked until confirmReceived
        /// is called.
        ...
        /// This will release the locked element.
