macro(configure_project)
	...
	# features
	ele_default_option(VMTRACE OFF)
	ele_default_option(PROFILING OFF)
	ele_default_option(FATDB ON)
	ele_default_option(ROCKSDB OFF)
	ele_default_option(OLYMPIC OFF)
	ele_default_option(PARANOID OFF)
	ele_default_option(MINIUPNPC ON)

	# components
	ele_default_option(GUI ON)
	ele_default_option(TESTS ON)
	ele_default_option(TOOLS ON)
	ele_default_option(ELHASHCL ON)
	ele_default_option(EVMJIT OFF)
	ele_default_option(SOLIDITY ON)
	...
	if (OLYMPIC)
		add_definitions(-DELE_OLYMPIC)
	else()
		add_definitions(-DELE_FRONTIER)
	endif()
...
if (SUPPORT_ELHASHCL)
	message("-- ELHASHCL         Build OpenCL components                  ${ELHASHCL}")
endif()
if (SUPPORT_EVMJIT)
