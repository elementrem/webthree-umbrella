# all dependencies that are not directly included in the cpp-elementrem distribution are defined here
# for this to work, download the dependency via the cmake script in extdep or install them manually!

function(ele_show_dependency DEP NAME)
	get_property(DISPLAYED GLOBAL PROPERTY ELE_${DEP}_DISPLAYED)
	if (NOT DISPLAYED)
		set_property(GLOBAL PROPERTY ELE_${DEP}_DISPLAYED TRUE)
...
if (DEFINED MSVC)
	...
	# this must be set to point to the same directory as $ELE_DEPENDENCY_INSTALL_DIR in /extdep directory

	if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.0.0)
		set (ELE_DEPENDENCY_INSTALL_DIR "${CMAKE_CURRENT_LIST_DIR}/../extdep/install/windows/x64")
	else()
		get_filename_component(DEPS_DIR "${CMAKE_CURRENT_LIST_DIR}/../deps/install" ABSOLUTE)
		set(ELE_DEPENDENCY_INSTALL_DIR
	...
	set (CMAKE_PREFIX_PATH ${ELE_DEPENDENCY_INSTALL_DIR} ${CMAKE_PREFIX_PATH})
...
# it's not used yet, but if we have more generated files, consider moving them to ELE_GENERATED_DIR
set(ELE_GENERATED_DIR "${PROJECT_BINARY_DIR}/gen")
include_directories(${ELE_GENERATED_DIR})

# boilerplate macros for some code editors
add_definitions(-DELE_TRUE)

# custom cmake scripts
set(ELE_CMAKE_DIR ${CMAKE_CURRENT_LIST_DIR})
set(ELE_SCRIPTS_DIR ${ELE_CMAKE_DIR}/scripts)

find_program(CTEST_COMMAND ctest)

#message(STATUS "CMAKE_PREFIX_PATH ${CMAKE_PREFIX_PATH}")
#message(STATUS "CMake Helper Path: ${ELE_CMAKE_DIR}")
#message(STATUS "CMake Script Path: ${ELE_SCRIPTS_DIR}")
...
ele_show_dependency(Boost boost)
...
function(ele_use TARGET REQUIRED)
	if (NOT TARGET ${TARGET})
		message(FATAL_ERROR "ele_use called for non existing target ${TARGET}")
	endif()
	...
	foreach(MODULE ${ARGN})
		...
		if (NOT TARGET_APPLIED)
			...
			ele_apply(${TARGET} ${REQUIRED} ${MODULE_SUB})
		endif()
	endforeach()
endfunction()
