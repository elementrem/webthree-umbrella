...
# the components within the Elementrem webthree-umbrella project.
#
# See http://github.com/elementrem/webthree-umbrella for more info on webthree
# See http://elementrem.org for more info on Elementrem
#
...
assignmentPattern = "(set|ele_name)\((EXECUTABLE|LIBRARY) (.*)\)"
dependencyPattern = "ele_use\((.*)\s+(OPTIONAL|REQUIRED)\s+(.*)\)"
...
# of the Elementrem libraries or executables, but does define CMake
...
# Hard-coded dependencies for 'libalele', which doesn't have a UseAlele.cmake
# to go with it, because the library is only used by the Alele* applications,
# and is not exposed to other applications.
print '    "AleleZero" -> "alele"'
