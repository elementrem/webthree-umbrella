...
void Debugger::populate(dev::ele::Executive& _executive, dev::ele::Transaction const& _transaction)
{
	finished();
...
bool DebugSession::populate(dev::ele::Executive& _executive, dev::ele::Transaction const& _transaction)
{
	try {
