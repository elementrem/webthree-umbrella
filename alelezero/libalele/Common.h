...
#define ELE_HTML_SMALL "font-size: small; "
#define ELE_HTML_MONO "font-family: Ubuntu Mono, Monospace, Lucida Console, Courier New; font-weight: bold; "
#define ELE_HTML_DIV(S) "<div style=\"" S "\">"
#define ELE_HTML_SPAN(S) "<span style=\"" S "\">"
