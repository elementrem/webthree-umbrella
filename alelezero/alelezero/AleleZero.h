...
#endif
#include <libalele/NatspecHandler.h>
#include <libalele/Common.h>
#include <libalele/Alele.h>
#include <libalele/RPCHost.h>
#include "ZeroFace.h"
#include "Plugin.h"
...
class AleleZero: public ZeroFace
{
	Q_OBJECT
...
public:
	...
	AleleWhisper* whisperFace() const override { return m_rpcHost.whisperFace(); }
	rpc::SessionManager* sessionManager() const override { return m_rpcHost.sessionManager(); }

	AleleFace const* alele() const override { return &m_alele; }
	AleleFace* alele() override { return &m_alele; }
