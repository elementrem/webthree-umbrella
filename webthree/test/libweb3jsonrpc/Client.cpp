 ...
 */
/**
 * @author Christian <chris@elementrem.org>
 * 
 */
...
BOOST_AUTO_TEST_CASE(Personal)
{
	...
	rpc::Personal personal(keyManager, accountHolder);
	rpc::Ele ele(*web3.elementrem(), accountHolder);
	...
	{
		BOOST_CHECK(!ele.ele_sendTransaction(tx).empty());
	};
