...
unique_ptr<ModularServer<rpc::EleFace, rpc::WhisperFace, rpc::NetFace, rpc::Web3Face, rpc::AdminNetFace, rpc::AdminUtilsFace>> modularServer;
...
struct Setup
{
	Setup()
	{
		...
		if (!setup)
		{
			...
			KeyManager keyMan;
			TrivialGasPricer gp;
			accountHolder.reset(new FixedAccountHolder([&](){return web3->elementrem();}, {}));
			whisperFace = new rpc::Whisper(*web3, {});
			//eleFace = new rpc::Ele(*web3->elementrem(), *accountHolder.get());
			...
			//modularServer.reset(new ModularServer<rpc::EleFace, rpc::WhisperFace, rpc::NetFace, rpc::Web3Face, rpc::AdminNetFace, rpc::AdminUtilsFace>(eleFace, whisperFace, netFace, w3Face, adminNetFace, adminUtilsFace));
