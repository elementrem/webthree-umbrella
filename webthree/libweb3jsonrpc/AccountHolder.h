...
public:
	...
	virtual TransactionNotification authenticate(dev::ele::TransactionSkeleton const& _t) = 0;
	...
	void queueTransaction(ele::TransactionSkeleton const& _transaction);

	std::vector<ele::TransactionSkeleton> const& queuedTransactions(int _id) const;
...
private:
	using TransactionQueue = std::vector<ele::TransactionSkeleton>;
...
public:
	...
	TransactionNotification authenticate(dev::ele::TransactionSkeleton const& _t) override;
