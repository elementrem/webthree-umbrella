...
TransactionNotification SimpleAccountHolder::authenticate(dev::ele::TransactionSkeleton const& _t)
{
...
TransactionNotification FixedAccountHolder::authenticate(dev::ele::TransactionSkeleton const& _t)
{
	TransactionNotification ret;
	if (isRealAccount(_t.from))
	{
