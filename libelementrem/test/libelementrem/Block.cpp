...
{	
	...
	BOOST_REQUIRE(ImportTest::compareStates(stateAfterInsert, stateAfterInsert1, ele::AccountMaskMap(), WhenError::DontThrow) == 1);

	State stateAfterInsert2 = block2.fromPending(2); //get the state of blockchain on current block executed
	BOOST_REQUIRE(ImportTest::compareStates(stateBofore, stateAfterInsert2, ele::AccountMaskMap(), WhenError::DontThrow) == 1);
	BOOST_REQUIRE(ImportTest::compareStates(stateAfterInsert1, stateAfterInsert2, ele::AccountMaskMap(), WhenError::DontThrow) == 1);
