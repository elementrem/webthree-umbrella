...
#include <libelementrem/BasicGasPricer.h>
...
void executeGasPricerTest(string const& name, double _elementPrice, double _blockFee, string const& bcTestPath, TransactionPriority _txPrio, u256 _expectedAsk, u256 _expectedBid, ele::Network _sealEngineNetwork = ele::Network::Test)
{
	BasicGasPricer gp(u256(double(element / 1000) / _elementPrice), u256(_blockFee * 1000));
...
{
	std::shared_ptr<dev::ele::GasPricer> gp(new TrivialGasPricer);
	BOOST_CHECK_EQUAL(gp->ask(Block(Block::Null)), DefaultGasPrice);
	BOOST_CHECK_EQUAL(gp->bid(), DefaultGasPrice);

	gp->update(BlockChain(ele::ChainParams(), TransientDirectory().path(), WithExisting::Kill));
	BOOST_CHECK_EQUAL(gp->ask(Block(Block::Null)), DefaultGasPrice);
	BOOST_CHECK_EQUAL(gp->bid(), DefaultGasPrice);
}
...
{
	BasicGasPricer gp(u256(double(element / 1000) / 30.679), u256(15.0 * 1000));
...
BOOST_AUTO_TEST_CASE(basicGasPricer_RPC_API_Test_Frontier)
{
	...
	dev::test::executeGasPricerTest("RPC_API_Test", 30.679, 15.0, "/BlockchainTests/bcRPC_API_Test.json", TransactionPriority::Medium, _expectedAsk, _expectedBid, ele::Network::FrontierTest);
}
...
BOOST_AUTO_TEST_CASE(basicGasPricer_RPC_API_Test_Homestead)
{
	...
	u256 _expectedBid = 155633980282;
	dev::test::executeGasPricerTest("RPC_API_Test", 30.679, 15.0, "/BlockchainTests/bcRPC_API_Test.json", TransactionPriority::Medium, _expectedAsk, _expectedBid, ele::Network::HomesteadTest);
}
...
BOOST_AUTO_TEST_CASE(basicGasPricer_bcUncleTest_Frontier)
{
	u256 _expectedAsk = 155632494086;
	u256 _expectedBid = 1;
	dev::test::executeGasPricerTest("twoUncle", 30.679, 15.0, "/BlockchainTests/bcUncleTest.json", TransactionPriority::Medium, _expectedAsk, _expectedBid, ele::Network::FrontierTest);
}
...
BOOST_AUTO_TEST_CASE(basicGasPricer_bcUncleTest_Homestead)
{
	u256 _expectedAsk = 155633980282;
	u256 _expectedBid = 1;
	dev::test::executeGasPricerTest("twoUncle", 30.679, 15.0, "/BlockchainTests/bcUncleTest.json", TransactionPriority::Medium, _expectedAsk, _expectedBid, ele::Network::HomesteadTest);
}
...
BOOST_AUTO_TEST_CASE(basicGasPricer_bcUncleHeaderValiditiy_Frontier)
{
	u256 _expectedAsk = 155632494086;
	u256 _expectedBid = 1;
	dev::test::executeGasPricerTest("correct", 30.679, 15.0, "/BlockchainTests/bcUncleHeaderValiditiy.json", TransactionPriority::Medium, _expectedAsk, _expectedBid, ele::Network::FrontierTest);
}
...
BOOST_AUTO_TEST_CASE(basicGasPricer_bcUncleHeaderValiditiy_Homestead)
{
	u256 _expectedAsk = 155633980282;
	u256 _expectedBid = 1;
	dev::test::executeGasPricerTest("correct", 30.679, 15.0, "/BlockchainTests/bcUncleHeaderValiditiy.json", TransactionPriority::Medium, _expectedAsk, _expectedBid, ele::Network::HomesteadTest);
}
...
BOOST_AUTO_TEST_CASE(basicGasPricer_notxs_frontier)
{
	...
	dev::test::executeGasPricerTest("notxs", 30.679, 15.0, "/BlockchainTests/bcGasPricerTest.json", TransactionPriority::Medium, _expectedAsk, _expectedBid, ele::Network::FrontierTest);
}
...
BOOST_AUTO_TEST_CASE(basicGasPricer_notxs_homestead)
{
	u256 _expectedAsk = 155633980282;
	u256 _expectedBid = 155633980282;
	dev::test::executeGasPricerTest("notxs", 30.679, 15.0, "/BlockchainTests/bcGasPricerTest.json", TransactionPriority::Medium, _expectedAsk, _expectedBid, ele::Network::HomesteadTest);
}
