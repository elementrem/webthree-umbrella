...
void printVersion()
{
	std::cout << "Elementrem EVM JIT Compiler (http://github.com/elementrem/evmjit):\n"
...
void parseOptions()
{
	...
	cl::ParseEnvironmentOptions("evmjit", "EVMJIT", "Elementrem EVM JIT Compiler");
}
