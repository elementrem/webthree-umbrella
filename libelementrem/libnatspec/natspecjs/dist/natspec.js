...
/*
    This file is part of elementrem.js.

    elementrem.js is free software: you can redistribute it and/or modify
    it under the terms of the GNU Lesser General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    elementrem.js is distributed in the hope that it will be useful,
...
var formatInputInt = function (value) {
    ...
    if (value instanceof BigNumber || typeof value === 'number') {
        ...
        BigNumber.config(c.ELE_BIGNUMBER_ROUNDING_MODE);
        value = value.round();
...
var formatInputString = function (value) {
    return utils.fromAscii(value, c.ELE_PADDING).substr(2);
};
...
/// used to transform value/string to ele string
/// TODO: use BigNumber.js to parse int
/// TODO: add tests for it!
var toEle = function (str) {
     /*jshint maxcomplexity:7 */
    var val = typeof str === "string" ? str.indexOf('0x') === 0 ? parseInt(str.substr(2), 16) : parseInt(str) : str;
    var unit = 0;
    var units = c.ELE_UNITS;
...
var abi = require('./node_modules/elementrem.js/lib/abi.js'); 
...
},{"./node_modules/elementrem.js/lib/abi.js":3}]},{},[]);
