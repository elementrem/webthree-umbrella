...
const char* WatchChannel::name() { return EleBlue "ℹ" EleWhite "  "; }
const char* WorkInChannel::name() { return EleOrange "⚒" EleGreen "▬▶"; }
const char* WorkOutChannel::name() { return EleOrange "⚒" EleNavy "◀▬"; }
const char* WorkChannel::name() { return EleOrange "⚒" EleWhite "  "; }

namespace dev { namespace ele { const u256 c_maxGasEstimate = 50000000; } }
