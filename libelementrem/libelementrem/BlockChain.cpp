...
#define ELE_CATCH 1
#define ELE_TIMED_IMPORTS 1

#if defined(_WIN32)
const char* BlockChainDebug::name() { return EleBlue "8" EleWhite " <>"; }
const char* BlockChainWarn::name() { return EleBlue "8" EleOnRed EleBlackBold " X"; }
const char* BlockChainNote::name() { return EleBlue "8" EleBlue " i"; }
const char* BlockChainChat::name() { return EleBlue "8" EleWhite " o"; }
#else
const char* BlockChainDebug::name() { return EleBlue "☍" EleWhite " ◇"; }
const char* BlockChainWarn::name() { return EleBlue "☍" EleOnRed EleBlackBold " ✘"; }
const char* BlockChainNote::name() { return EleBlue "☍" EleBlue " ℹ"; }
const char* BlockChainChat::name() { return EleBlue "☍" EleWhite " ◌"; }
#endif

std::ostream& dev::ele::operator<<(std::ostream& _out, BlockChain const& _bc)
{
...
ldb::Slice dev::ele::toSlice(h256 const& _h, unsigned _sub)
{
...
ldb::Slice dev::ele::toSlice(uint64_t _n, unsigned _sub)
{
#if ALL_COMPILERS_ARE_CPP11_COMPLIANT
	...
	if (!m_blocksDB || !m_extrasDB)
	{
		...
		else
		{
			cwarn <<
				...
				"or " <<
				(extrasPath + "/extras") <<
				"already open. You appear to have another instance of elementrem running. Bailing.";
...
Block BlockChain::genesisBlock(OverlayDB const& _db) const
{
	...
	ret.noteChain(*this);
	dev::ele::commit(m_params.genesisState, ret.mutableState().m_state);	// bit horrible. maybe consider a better way of constructing it?
