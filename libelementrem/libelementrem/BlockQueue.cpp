...
#if defined(_WIN32)
const char* BlockQueueChannel::name() { return EleOrange "[]>"; }
#else
const char* BlockQueueChannel::name() { return EleOrange "▣┅▶"; }
#endif
const char* BlockQueueTraceChannel::name() { return EleOrange "▣ ▶"; }
...
std::ostream& dev::ele::operator<<(std::ostream& _out, BlockQueueStatus const& _bqs)
{
...
std::ostream& dev::ele::operator<< (std::ostream& os, QueueStatus const& obj)
{
