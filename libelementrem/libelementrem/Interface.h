...
public:
	...
	/// NOTE: This only works when compiled with ELE_FATDB; otherwise will throw InterfaceNotSupported.
...
namespace std { void swap(dev::ele::Watch& _a, dev::ele::Watch& _b); }
...
inline void swap(dev::ele::Watch& _a, dev::ele::Watch& _b)
{
	swap(_a.m_c, _b.m_c);
