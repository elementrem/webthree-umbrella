...
#define ELE_TIMED_ENACTMENTS 0

const char* StateSafeExceptions::name() { return EleViolet "⚙" EleBlue " ℹ"; }
const char* StateDetail::name() { return EleViolet "⚙" EleWhite " ◌"; }
const char* StateTrace::name() { return EleViolet "⚙" EleGray " ◎"; }
const char* StateChat::name() { return EleViolet "⚙" EleWhite " ◌"; }
...
void State::commit()
{
	m_touched += dev::ele::commit(m_cache, m_state);
	m_cache.clear();
}
...
std::ostream& dev::ele::operator<<(std::ostream& _out, State const& _s)
{
