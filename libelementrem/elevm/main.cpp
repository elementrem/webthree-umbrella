...
{
	cout
		<< "Usage elevm <options> [trace|stats|output] (<file>|--)" << endl
		<< "Transaction options:" << endl
		<< "    --value <n>  Transaction should transfer the <n> mey (default: 0)." << endl
...
void version()
{
	cout << "elevm version " << dev::Version << endl;
...
int main(int argc, char** argv)
{
	...
	Transaction t = ele::Transaction(value, gasPrice, gas, data, 0);
