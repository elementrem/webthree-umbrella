...
const std::map<std::string, Instruction> dev::ele::c_instructions =
{
...
string dev::ele::disassemble(bytes const& _mem)
{
	stringstream ret;
...
InstructionInfo dev::ele::instructionInfo(Instruction _inst)
{
	try
	{
...
bool dev::ele::isValidInstruction(Instruction _inst)
{
