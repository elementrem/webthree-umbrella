...
#define ELE_REGISTER_SEAL_ENGINE(Name) static SealEngineFactory __ele_registerSealEngineFactory ## Name = SealEngineRegistrar::registerSealEngine<Name>(#Name)

class NoProof: public ele::SealEngineBase
{
public:
