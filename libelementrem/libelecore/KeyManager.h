...
// TODO: This one is specifically for Elementrem, but we can make it generic in due course.
// TODO: hidden-partition style key-store.
/**
 * @brief High-level manager of password-encrypted keys for Elementrem.
 * Usage:
 *
...
public:
	...
	static std::string defaultPath() { return getDataDir("elementrem") + "/keys.info"; }
