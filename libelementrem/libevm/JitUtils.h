...
/// Converts EVM JIT representation of 256-bit integer to ele type dev::u256.
inline u256 jit2ele(evmjit::i256 _i)
{
	u256 u = _i.words[3];
	u <<= 64;
	u |= _i.words[2];
...
/// Converts ele type dev::u256 to EVM JIT representation of 256-bit integer.
inline evmjit::i256 ele2jit(u256 _u)
{
	evmjit::i256 i;
...
/// Converts ele type dev::h256 to EVM JIT representation of 256-bit hash value.
inline evmjit::h256 ele2jit(h256 _u)
{
