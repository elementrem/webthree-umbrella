...
class Elhash: public SealEngineFace
{
public:
	Elhash();

	std::string name() const override { return "Elhash"; }
	...
	ele::GenericFarm<ElhashProofOfWork>& farm() { return m_farm; }
...
private:
	...
	ele::GenericFarm<ElhashProofOfWork> m_farm;
