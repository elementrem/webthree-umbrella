...
class ElhashClient: public Client
{
public:
	...
	std::tuple<h256, h256, h256> getElhashWork();
	 ...
	 */
	bool submitElhashWork(h256 const& _mixHash, h64 const& _nonce);
...
ElhashClient& asElhashClient(Interface& _c);
ElhashClient* asElhashClient(Interface* _c);
